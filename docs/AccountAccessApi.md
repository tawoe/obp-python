...
------------- | ------------- | -------------
[**o_bpv4_0_0_create_user_with_account_access**](AccountAccessApi.md#o_bpv4_0_0_create_user_with_account_access) | **POST** /obp/v5.0.0/banks/{BANK_ID}/accounts/{ACCOUNT_ID}/user-account-access | Create (DAuth) User with Account Access
[**o_bpv4_0_0_grant_user_access_to_view**](AccountAccessApi.md#o_bpv4_0_0_grant_user_access_to_view) | **POST** /obp/v5.0.0/banks/{BANK_ID}/accounts/{ACCOUNT_ID}/account-access/grant | Grant User access to View
[**o_bpv4_0_0_revoke_grant_user_access_to_views**](AccountAccessApi.md#o_bpv4_0_0_revoke_grant_user_access_to_views) | **PUT** /obp/v5.0.0/banks/{BANK_ID}/accounts/{ACCOUNT_ID}/account-access | Revoke/Grant User access to View
[**o_bpv4_0_0_revoke_user_access_to_view**](AccountAccessApi.md#o_bpv4_0_0_revoke_user_access_to_view) | **POST** /obp/v5.0.0/banks/{BANK_ID}/accounts/{ACCOUNT_ID}/account-access/revoke | Revoke User access to View
...
api_instance = obp_python.AccountAccessApi(obp_python.ApiClient(configuration))
...
try:
    ...
    print("Exception when calling AccountAccessApi->o_bpv4_0_0_create_user_with_account_access: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AccountAccessApi->o_bpv4_0_0_grant_user_access_to_view: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AccountAccessApi->o_bpv4_0_0_revoke_grant_user_access_to_views: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling AccountAccessApi->o_bpv4_0_0_revoke_user_access_to_view: %s\n" % e)
```
