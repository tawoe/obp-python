...
from obp_python.apis.account_information_service_ais_api import AccountInformationServiceAISApi
...
class TestAccountInformationServiceAISApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = obp_python.apis.account_information_service_ais_api.AccountInformationServiceAISApi()
